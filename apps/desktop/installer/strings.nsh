...
LangString INSTALLER_GUIDE1_LINE1 ${LANG_ENGLISH} "The most advanced, professional and intelligent coding and"
LangString INSTALLER_GUIDE1_LINE1 ${LANG_SIMPCHINESE} "面向软件工程、软件外包与 VibeCoding 领域，"
LangString INSTALLER_GUIDE1_LINE2 ${LANG_ENGLISH} "office tool for software engineering, outsourcing and VibeCoding."
LangString INSTALLER_GUIDE1_LINE2 ${LANG_SIMPCHINESE} "最先进、最专业、最智能的编码与办公工具。"
LangString INSTALLER_GUIDE1_LINE3 ${LANG_ENGLISH} "Closes the DSH context-compaction gap; high cache hit rate."
LangString INSTALLER_GUIDE1_LINE3 ${LANG_SIMPCHINESE} "补齐 DSH 上下文压缩短板，长链路产出稳定、缓存命中率高。"
