...
export const en = {
  ...
  aboutMenu: 'About TianmaCoder',
  hideApplication: 'Hide TianmaCoder',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit TianmaCoder',
  edit: 'Edit',
  ...
  startupFailed: 'TianmaCoder is unavailable',
  ...
  welcomeTitle: 'TianmaCoder',
  welcomeBrand: 'TianmaCoder',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'TianmaCoder',
  welcomeTaglineAfter: '',
  welcomeDescription: 'Build potential. Explore intelligence.',
  welcomeAccountNote: 'Sign in with your Tianma OA account inside the app to send messages.',
  welcomeApiKey: 'Add API Key',
  welcomeKeyTitle: 'Add an API key to get started',
  welcomeKeyDescription: 'Configure official DeepSeek models to start using TianmaCoder',
  ...
  updateDownloadedTitle: 'TianmaCoder v{version} downloaded',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 TianmaCoder',
  hideApplication: '隐藏 TianmaCoder',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 TianmaCoder',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'TianmaCoder 无法使用',
  ...
  welcomeAccountNote: '请在应用内使用天码 OA 账号登录后发送消息。',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'TianmaCoder v{version} 下载完成',
