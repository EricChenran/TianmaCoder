...
export const en = {
  ...
  addCatalogHint: 'Pick 智谱 GLM, OpenAI, Anthropic, Kimi, or another provider from the built-in catalog and enter its API key.',
  ...
  provider: 'Provider',
  'provider.zai-coding-cn': 'Zhipu GLM Coding Plan',
  'provider.zai': 'Z.AI (Zhipu International)',
  'provider.commandcode-goat': 'Command Code GOAT plan',
  close: 'Close',
  cancel: 'Cancel',
  apply: 'Apply',
  applying: 'Applying…',
  ...
  welcomeBody: "TianmaCoder 0.1 remains in testing for Harness developers. Many areas need further improvement, and we welcome feedback from the developer community. TianmaCoder's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the DSH plugin ecosystem.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  addCatalog: '第三方模型提供商',
  addCustom: '自定义模型 API',
  addCatalogHint: '从内置目录中选择 智谱 GLM、OpenAI、Anthropic、Kimi 等提供商，填入其 API 密钥即可使用。',
  ...
  provider: '提供商',
  'provider.zai-coding-cn': '智谱 GLM Coding Plan',
  'provider.zai': 'Z.AI（智谱国际）',
  'provider.commandcode-goat': 'Command Code GOAT 计划',
  close: '关闭',
  cancel: '取消',
  apply: '保存',
  applying: '保存中…',
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'TianmaCoder 目前的 0.1 版本仍处在面向 Harness 开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取广大开发者的反馈建议。预计 DeepSeek Harness 的核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球 Harness 开发者加入 DSH 插件生态。',
  welcomeContinue: '继续',
