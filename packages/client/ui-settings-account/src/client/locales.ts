...
export const en = {
  ...
  loading: 'Loading…', backToHarness: 'Back to TianmaCoder',
  settings: 'Settings', contactUs: 'Contact us', menu: 'Account menu',
  ...
  settingsSignedOutTitle: 'You are not signed in to TianmaCoder',
  settingsSignedOutDescription: 'Sign in to TianmaCoder to get your dedicated API Key',
...
export const zh: Record<AccountKey, string> = {
  ...
  loading: '加载中…', backToHarness: '返回 TianmaCoder',
  settings: '设置', contactUs: '联系我们', menu: '账号菜单',
  ...
  failed: '操作未完成，请重试。',
  settingsSignedOutTitle: '当前未登录 TianmaCoder 账号',
  settingsSignedOutDescription: '登录 TianmaCoder 账号获取专属 API Key',
