...
import {
  IconChevronDownOutlineRegular, IconFolderCloseRegular, IconFolderOpenRegular, TianmaLogo,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* Brand mark 34px wide leading the headline, gap 10. The hover hitbox
             keeps the CSS sway animation (HeroShell.module.css) alive. */}
          <span className={css.fishHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.fish }, {
              fallback: <TianmaLogo size={34} className={css.fish} />,
            })}
          </span>
