...
export const zh = {
  ...
  'error.signInRequired': '登录后才能发送消息。',
  'error.accountInactive': '当前账号不可用，请联系管理员。',
...
export const en = {
  ...
  'hero.headline': 'What are we building today?',
  ...
  'error.signInRequired': 'Sign in to send messages.',
  'error.accountInactive': 'This account is not active. Contact your administrator.',
