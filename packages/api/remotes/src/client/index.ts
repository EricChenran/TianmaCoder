...
import oaAccountRemote from '@tianma/dsh-oa-account/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      permissionPresetsRemote, oaAccountRemote,
      subagentsRemote, sessionRemote, jobRemote, workspaceRemote, workspaceFilesRemote, terminalRemote,
      officeToPdfRemote,
    ]) {
