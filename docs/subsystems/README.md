...
| [tianma.md](tianma.md) | the Tianma integration family: ZCode-derived compaction-quality plugins mounted as one profile-patch bundle, with fail-closed patch verification |
